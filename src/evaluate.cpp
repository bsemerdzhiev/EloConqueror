...
const int32_t mg_value[6] = {0, 1025, 477, 365, 337, 82};
const int32_t eg_value[6] = {0, 936, 512, 297, 281, 94};
/* piece/sq tables */
/* values from Rofchade:
 * http://www.talkchess.com/forum3/viewtopic.php?f=2&t=68311&start=19 */

const int32_t mg_pawn_table[64] = {
...
const int32_t eg_pawn_table[64] = {
...
const int32_t mg_knight_table[64] = {
...
const int32_t eg_knight_table[64] = {
...
const int32_t mg_bishop_table[64] = {
...
const int32_t eg_bishop_table[64] = {
...
const int32_t mg_rook_table[64] = {
...
const int32_t eg_rook_table[64] = {
...
const int32_t mg_queen_table[64] = {
...
const int32_t eg_queen_table[64] = {
...
const int32_t mg_king_table[64] = {
...
const int32_t eg_king_table[64] = {
...
const int32_t *mg_pesto_table[6] = {
    mg_king_table,   mg_queen_table,  mg_rook_table,
    mg_bishop_table, mg_knight_table, mg_pawn_table,
};

const int32_t *eg_pesto_table[6] = {
    eg_king_table,   eg_queen_table,  eg_rook_table,
    eg_bishop_table, eg_knight_table, eg_pawn_table,
};

const int32_t gamephase_inc[12] = {0, 0, 4, 4, 2, 2, 1, 1, 1, 1, 0, 0};
